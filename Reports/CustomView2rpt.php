...
//	var $SelectLimit = TRUE;
	...
	function crCustomView2() {
		...
		// First Name
		$this->First_Name = new crField('CustomView2', 'CustomView2', 'x_First_Name', 'First Name', 's.first_name', 200, EWRPT_DATATYPE_STRING, -1);
		...
		// Paper Name
		$this->Paper_Name = new crField('CustomView2', 'CustomView2', 'x_Paper_Name', 'Paper Name', 'p.paper_name', 200, EWRPT_DATATYPE_STRING, -1);
		...
		// No Of Attempts
		$this->No_Of_Attempts = new crField('CustomView2', 'CustomView2', 'x_No_Of_Attempts', 'No Of Attempts', 'Count(c.paper_id)', 20, EWRPT_DATATYPE_NUMBER, -1);
		$this->No_Of_Attempts->FldDefaultErrMsg = $ReportLanguage->Phrase("IncorrectInteger");
		$this->fields['No_Of_Attempts'] =& $this->No_Of_Attempts;
		$this->No_Of_Attempts->DateFilter = "";
		$this->No_Of_Attempts->SqlSelect = "";
		$this->No_Of_Attempts->SqlOrderBy = "";
	}
	...
	function SqlFrom() { // From
		return "class_std c, papers p, students s";
	}

	function SqlSelect() { // Select
		return "SELECT s.first_name As `First Name`, p.paper_name As `Paper Name`, Count(c.paper_id) As `No Of Attempts` FROM " . $this->SqlFrom();
	}

	function SqlWhere() { // Where
		return "p.paper_id = c.paper_id And c.std_id = s.std_id";
	}

	function SqlGroupBy() { // Group By
		return "c.paper_id, c.std_id";
	}
...
<?php if ($CustomView2->Export <> "") { ?>
<?php echo $CustomView2->First_Name->FldCaption() ?>
<?php } else { ?>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<?php if ($CustomView2->SortUrl($CustomView2->First_Name) == "") { ?>
		<td style="vertical-align: bottom;"><?php echo $CustomView2->First_Name->FldCaption() ?></td>
<?php } else { ?>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<?php echo $CustomView2->SortUrl($CustomView2->First_Name) ?>',0);"><?php echo $CustomView2->First_Name->FldCaption() ?></td><td style="width: 10px;">
		<?php if ($CustomView2->First_Name->getSort() == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($CustomView2->First_Name->getSort() == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
<?php } ?>
	</tr></table>
<?php } ?>
</td>
<td class="ewTableHeader">
<?php if ($CustomView2->Export <> "") { ?>
<?php echo $CustomView2->Paper_Name->FldCaption() ?>
<?php } else { ?>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<?php if ($CustomView2->SortUrl($CustomView2->Paper_Name) == "") { ?>
		<td style="vertical-align: bottom;"><?php echo $CustomView2->Paper_Name->FldCaption() ?></td>
<?php } else { ?>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<?php echo $CustomView2->SortUrl($CustomView2->Paper_Name) ?>',0);"><?php echo $CustomView2->Paper_Name->FldCaption() ?></td><td style="width: 10px;">
		<?php if ($CustomView2->Paper_Name->getSort() == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($CustomView2->Paper_Name->getSort() == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
<?php } ?>
	</tr></table>
<?php } ?>
</td>
<td class="ewTableHeader">
<?php if ($CustomView2->Export <> "") { ?>
<?php echo $CustomView2->No_Of_Attempts->FldCaption() ?>
<?php } else { ?>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<?php if ($CustomView2->SortUrl($CustomView2->No_Of_Attempts) == "") { ?>
		<td style="vertical-align: bottom;"><?php echo $CustomView2->No_Of_Attempts->FldCaption() ?></td>
<?php } else { ?>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<?php echo $CustomView2->SortUrl($CustomView2->No_Of_Attempts) ?>',0);"><?php echo $CustomView2->No_Of_Attempts->FldCaption() ?></td><td style="width: 10px;">
		<?php if ($CustomView2->No_Of_Attempts->getSort() == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($CustomView2->No_Of_Attempts->getSort() == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
<?php } ?>
	</tr></table>
<?php } ?>
</td>
...
?>
	<tr<?php echo $CustomView2->RowAttributes(); ?>>
		<td<?php echo $CustomView2->First_Name->CellAttributes() ?>>
<div<?php echo $CustomView2->First_Name->ViewAttributes(); ?>><?php echo $CustomView2->First_Name->ListViewValue(); ?></div>
</td>
		<td<?php echo $CustomView2->Paper_Name->CellAttributes() ?>>
<div<?php echo $CustomView2->Paper_Name->ViewAttributes(); ?>><?php echo $CustomView2->Paper_Name->ListViewValue(); ?></div>
</td>
		<td<?php echo $CustomView2->No_Of_Attempts->CellAttributes() ?>>
<div<?php echo $CustomView2->No_Of_Attempts->ViewAttributes(); ?>><?php echo $CustomView2->No_Of_Attempts->ListViewValue(); ?></div>
</td>
	</tr>
<?php
...
class crCustomView2_rpt {
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
		...
		if (!$rs->EOF) {
			$CustomView2->First_Name->setDbValue($rs->fields('First Name'));
			$CustomView2->Paper_Name->setDbValue($rs->fields('Paper Name'));
			$CustomView2->No_Of_Attempts->setDbValue($rs->fields('No Of Attempts'));
			$this->Val[1] = $CustomView2->First_Name->CurrentValue;
			$this->Val[2] = $CustomView2->Paper_Name->CurrentValue;
			$this->Val[3] = $CustomView2->No_Of_Attempts->CurrentValue;
		} else {
			$CustomView2->First_Name->setDbValue("");
			$CustomView2->Paper_Name->setDbValue("");
			$CustomView2->No_Of_Attempts->setDbValue("");
		}
	}
	...
	function RenderRow() {
		...
		if ($CustomView2->RowType == EWRPT_ROWTYPE_TOTAL) { // Summary row
			...
			// First Name
			$CustomView2->First_Name->ViewValue = $CustomView2->First_Name->Summary;

			// Paper Name
			$CustomView2->Paper_Name->ViewValue = $CustomView2->Paper_Name->Summary;

			// No Of Attempts
			$CustomView2->No_Of_Attempts->ViewValue = $CustomView2->No_Of_Attempts->Summary;
		} else {

			// First Name
			$CustomView2->First_Name->ViewValue = $CustomView2->First_Name->CurrentValue;
			$CustomView2->First_Name->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// Paper Name
			$CustomView2->Paper_Name->ViewValue = $CustomView2->Paper_Name->CurrentValue;
			$CustomView2->Paper_Name->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// No Of Attempts
			$CustomView2->No_Of_Attempts->ViewValue = $CustomView2->No_Of_Attempts->CurrentValue;
			$CustomView2->No_Of_Attempts->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		}

		// First Name
		$CustomView2->First_Name->HrefValue = "";

		// Paper Name
		$CustomView2->Paper_Name->HrefValue = "";

		// No Of Attempts
		$CustomView2->No_Of_Attempts->HrefValue = "";
	...
	function GetSort() {
		...
		if (strlen(@$_GET["cmd"]) > 0) {
			...
			if ($sCmd == "resetsort") {
				...
				$CustomView2->First_Name->setSort("");
				$CustomView2->Paper_Name->setSort("");
				$CustomView2->No_Of_Attempts->setSort("");
			}

...
//	var $SelectLimit = TRUE;
	...
	function crCustomView1() {
		...
		// paper_name
		$this->paper_name = new crField('CustomView1', 'CustomView1', 'x_paper_name', 'paper_name', 'papers.paper_name', 200, EWRPT_DATATYPE_STRING, -1);
		...
		$this->Count28Distinct_class_std2Estd_id29 = new crField('CustomView1', 'CustomView1', 'x_Count28Distinct_class_std2Estd_id29', 'Count(Distinct class_std.std_id)', '`Count(Distinct class_std.std_id)`', 20, EWRPT_DATATYPE_NUMBER, -1);
...
<?php if ($CustomView1->Export <> "") { ?>
<?php echo $CustomView1->paper_name->FldCaption() ?>
<?php } else { ?>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<?php if ($CustomView1->SortUrl($CustomView1->paper_name) == "") { ?>
		<td style="vertical-align: bottom;"><?php echo $CustomView1->paper_name->FldCaption() ?></td>
<?php } else { ?>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<?php echo $CustomView1->SortUrl($CustomView1->paper_name) ?>',0);"><?php echo $CustomView1->paper_name->FldCaption() ?></td><td style="width: 10px;">
		<?php if ($CustomView1->paper_name->getSort() == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($CustomView1->paper_name->getSort() == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
<?php } ?>
	</tr></table>
<?php } ?>
</td>
<td class="ewTableHeader">
<?php if ($CustomView1->Export <> "") { ?>
<?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->FldCaption() ?>
<?php } else { ?>
	<table cellspacing="0" class="ewTableHeaderBtn"><tr>
<?php if ($CustomView1->SortUrl($CustomView1->Count28Distinct_class_std2Estd_id29) == "") { ?>
		<td style="vertical-align: bottom;"><?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->FldCaption() ?></td>
<?php } else { ?>
		<td class="ewPointer" onmousedown="ewrpt_Sort(event,'<?php echo $CustomView1->SortUrl($CustomView1->Count28Distinct_class_std2Estd_id29) ?>',0);"><?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->FldCaption() ?></td><td style="width: 10px;">
		<?php if ($CustomView1->Count28Distinct_class_std2Estd_id29->getSort() == "ASC") { ?><img src="phprptimages/sortup.gif" width="10" height="9" border="0"><?php } elseif ($CustomView1->Count28Distinct_class_std2Estd_id29->getSort() == "DESC") { ?><img src="phprptimages/sortdown.gif" width="10" height="9" border="0"><?php } ?></td>
<?php } ?>
	</tr></table>
<?php } ?>
</td>
...
?>
	<tr<?php echo $CustomView1->RowAttributes(); ?>>
		<td<?php echo $CustomView1->paper_name->CellAttributes() ?>>
<div<?php echo $CustomView1->paper_name->ViewAttributes(); ?>><?php echo $CustomView1->paper_name->ListViewValue(); ?></div>
</td>
		<td<?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->CellAttributes() ?>>
<div<?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->ViewAttributes(); ?>><?php echo $CustomView1->Count28Distinct_class_std2Estd_id29->ListViewValue(); ?></div>
</td>
	</tr>
<?php
...
class crCustomView1_rpt {
	...
	//		$rs->MoveFirst(); // NOTE: no need to move position
		...
		if (!$rs->EOF) {
			$CustomView1->paper_name->setDbValue($rs->fields('paper_name'));
			$CustomView1->Count28Distinct_class_std2Estd_id29->setDbValue($rs->fields('Count(Distinct class_std.std_id)'));
			$this->Val[1] = $CustomView1->paper_name->CurrentValue;
			$this->Val[2] = $CustomView1->Count28Distinct_class_std2Estd_id29->CurrentValue;
		} else {
			$CustomView1->paper_name->setDbValue("");
			$CustomView1->Count28Distinct_class_std2Estd_id29->setDbValue("");
		}
	}
	...
	function RenderRow() {
		...
		if ($CustomView1->RowType == EWRPT_ROWTYPE_TOTAL) { // Summary row
			...
			// paper_name
			$CustomView1->paper_name->ViewValue = $CustomView1->paper_name->Summary;

			// Count(Distinct class_std.std_id)
			$CustomView1->Count28Distinct_class_std2Estd_id29->ViewValue = $CustomView1->Count28Distinct_class_std2Estd_id29->Summary;
		} else {

			// paper_name
			$CustomView1->paper_name->ViewValue = $CustomView1->paper_name->CurrentValue;
			$CustomView1->paper_name->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";

			// Count(Distinct class_std.std_id)
			$CustomView1->Count28Distinct_class_std2Estd_id29->ViewValue = $CustomView1->Count28Distinct_class_std2Estd_id29->CurrentValue;
			$CustomView1->Count28Distinct_class_std2Estd_id29->CellAttrs["class"] = ($this->RecCount % 2 <> 1) ? "ewTableAltRow" : "ewTableRow";
		}

		// paper_name
		$CustomView1->paper_name->HrefValue = "";

		// Count(Distinct class_std.std_id)
		$CustomView1->Count28Distinct_class_std2Estd_id29->HrefValue = "";

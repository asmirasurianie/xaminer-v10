...
$row= mysql_fetch_array($sql);
			...
			?>
			 ...
			 <input type="hidden" name="UserId" value="<?php echo $_REQUEST['uid'];?>">
               <table   border="0"  width="45%" cellspacing="20" cellpadding="2"  align="left" summary="Password Forgoten Table">
			   
                <tr>
				
                  <td class="login"  width="50%">First Name :</td>

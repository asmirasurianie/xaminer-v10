...
<form name="frmAdduser" id="frmAdduser" method="post"  enctype="multipart/form-data" action="addstudents_process.php">
    <table   border="0" width="40%" cellspacing="3" cellpadding="2"  align="left" summary="Password Forgoten Table">
        ...
        <tr>
        	<td >
        	<input type="submit" value="SUBMIT" name="addstudent" id="addstudent" class="sub-butt" onclick="return  checkstudents();"/>&nbsp;</td>
			<td><input type="button" value="cancel" class="sub-butt" onclick="cancelstudent();return false;"/></td>
        </tr>
    </table>
</form>
